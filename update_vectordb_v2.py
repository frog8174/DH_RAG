...
from remote_embeddings import RemoteEmbeddings  # 如果沒用到也可以拿掉

total_chunks = []

# 設定本地 embedding model (needs GPU)
emb = HuggingFaceBgeEmbeddings(
    model_name="BAAI/bge-m3", # Qwen/Qwen3-Embedding-0.6B
    model_kwargs={'device': 'cuda:1'},  # 根據你的硬體，可以改為 'cuda' 或 'mps'
