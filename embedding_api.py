...
# 注意：請確保運行此 API 的機器上存在指定的 CUDA 設備
# 如果您想使用 CPU，請改為 {"device": "cpu"}
...
def embed_texts(request: EmbeddingRequest):
    ...
    try:
        ...
        # 使用模型的 embed_documents 方法來處理批量請求
...
#     # host="0.0.0.0" 讓區域網路中的其他電腦也能訪問
#     # port=8000 是常用的 API 埠號
